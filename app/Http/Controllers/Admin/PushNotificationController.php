...
class PushNotificationController extends Controller
{
    ...
    public function sendNotificationWithFirebase($data) {
        ...
        $userTokens = \App\Models\FireBaseToken::where('tokenable_type', \App\Models\User::class)->pluck('token')->toArray();
        $adminTokens = \App\Models\FireBaseToken::where('tokenable_type', \App\Models\Admin\Admin::class)->pluck('token')->toArray();
        
        $allTokens = array_merge($userTokens, $adminTokens);
